...
print('create job, return : ' + str(conn.create_job_v2(job)))

job.set_parameter('action', 'stop')
print('update job, return : ' + str(conn.update_job_v2(job)))

print('get job: return : ' + str(conn.get_job_v2(job.get_job_id())))

print('delete job: return : ' + str(conn.delete_job_v2(job.get_job_id())))
